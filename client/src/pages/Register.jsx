...
import { FormInput } from '../components/Button/FormInput/formInput'
import { Button, Grid, InputAdornment, Link, TextField } from '@material-ui/core';
...
export const Register = () => {
    ...
    const {username, email, password, confirmPassword, fullname, phone, address } = data
      ...
      <div>
        <Grid container >
          <Grid container 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', maxWidth: 500, minWidth: 300, width: '100%'}}>
              ...
              <form style={{ display: 'flex', flexDirection: 'column', maxWidth: 500, minWidth: 300, width: '100%'}} onSubmit={onSubmit}>
              <TextField
               label="Username"
               variant="outlined"
               margin="normal"
               ...
               helperText={isInvalid.username ? "Vui lòng điền vào trường này" : ''}
              />
              <TextField
               label="Email"
               margin="normal"
              ...
              <TextField
               ...
               helperText={isInvalid.confirmPassword ? "Mat khau khong trung khop" : ''}
              />
              <TextField
               label="Fullname" 
               margin="normal" 
               ...
               helperText={isInvalid.fullname ? "Vui lòng điền vào trường này" : ''}
              />
              <TextField
               label="Phone number"
               margin="normal"
              ...
              <TextField
               ...
               helperText={isInvalid.address ? "Vui lòng điền vào trường này" : ''}
              />
              ...
              <Link href="/signin" variant="body2" style={{fontSize: '14px'}} >
                 Sign in
              </Link>
              </div>
